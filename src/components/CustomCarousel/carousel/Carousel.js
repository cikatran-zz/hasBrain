...
export default class Carousel extends Component {
    ...
    _getCenter (offset) {
        return offset + this._getViewportOffet() - this._getContainerInnerMargin(false, false);
    }
    ...
    _initPositionsAndInterpolators (props = this.props) {
        ...
        let interpolators = [];
        this._positions = [];
        let centerPadding = (sliderWidth - itemWidth) / 2;
        let customData = this._getCustomData(props)
        customData.forEach((itemData, index) => {
            ...
            this._positions[index] = {
                ...
                end: index * sizeRef - startPadding + sizeRef - endPadding
            };
